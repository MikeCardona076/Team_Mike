...
class BarracksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create barrack" do
    assert_difference('Barrack.count') do
      post barracks_url, params: { barrack: { i_d: @barrack.i_d, location: @barrack.location, name_barrack: @barrack.name_barrack } }
    end
  ...
  test "should update barrack" do
    patch barrack_url(@barrack), params: { barrack: { i_d: @barrack.i_d, location: @barrack.location, name_barrack: @barrack.name_barrack } }

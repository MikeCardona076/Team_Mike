...
class SoldiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create soldier" do
    assert_difference('Soldier.count') do
      post soldiers_url, params: { soldier: { grade: @soldier.grade, i_d: @soldier.i_d, name: @soldier.name } }
    end
  ...
  test "should update soldier" do
    patch soldier_url(@soldier), params: { soldier: { grade: @soldier.grade, i_d: @soldier.i_d, name: @soldier.name } }
